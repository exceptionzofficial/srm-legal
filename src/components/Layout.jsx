...
import { FiUsers, FiDollarSign, FiLogOut, FiMenu, FiFileText, FiClipboard, FiFolder } from 'react-icons/fi';
...
const Layout = () => {
    ...
    const CURRENT_USER_ID = user.employeeId || 'LEGAL-ADMIN-DEFAULT'; // Fallback to avoid 404s
        ...
        <div className="layout">
            ...
            <main className="content">
                ...
                <header className="top-bar">
                    ...
                    <span style={{ fontWeight: 500 }}>Welcome, Legal Admin</span>
                </header>
